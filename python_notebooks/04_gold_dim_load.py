...
(
    ...
    .option("path", f"{GOLD_PATH}/dim_date").saveAsTable(f"{GOLD_SCHEMA}.dim_date")
)
...
(
    ...
    .mode("overwrite")
    .option("overwriteSchema", True)
    .option("path", f"{GOLD_PATH}/dim_location").saveAsTable(f"{GOLD_SCHEMA}.dim_location")
)
...
(
    ...
    .mode("overwrite")
    .option("overwriteSchema", True)
    .option("path", f"{GOLD_PATH}/dim_inspection_type").saveAsTable(f"{GOLD_SCHEMA}.dim_inspection_type")
)
...
(
    ...
    .mode("overwrite")
    .option("overwriteSchema", True)
    .option("path", f"{GOLD_PATH}/dim_violation").saveAsTable(f"{GOLD_SCHEMA}.dim_violation")
)
...
(
    ...
    .mode("overwrite")
    .option("overwriteSchema", True)
    .option("path", f"{GOLD_PATH}/fact_inspection").saveAsTable(f"{GOLD_SCHEMA}.fact_inspection")
)
...
(
    ...
    .mode("overwrite")
    .option("overwriteSchema", True)
    .option("path", f"{GOLD_PATH}/bridge_inspection_violation").saveAsTable(f"{GOLD_SCHEMA}.bridge_inspection_violation")
)
