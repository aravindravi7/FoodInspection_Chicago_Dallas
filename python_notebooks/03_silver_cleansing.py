...
(
    ...
    .option("path", f"{SILVER_PATH}/chicago_inspections").saveAsTable(f"{SILVER_SCHEMA}.chicago_inspections")
)
...
(
    ...
    .mode("overwrite")
    .option("overwriteSchema", True)
    .option("path", f"{SILVER_PATH}/chicago_violations").saveAsTable(f"{SILVER_SCHEMA}.chicago_violations")
)
...
(
    ...
    .mode("overwrite")
    .option("overwriteSchema", True)
    .option("path", f"{SILVER_PATH}/dallas_inspections").saveAsTable(f"{SILVER_SCHEMA}.dallas_inspections")
)
...
(
    ...
    .transform(lambda df: add_silver_lineage(df, ["Inspection_ID", "violation_code"]))
    .write
    .format("delta")
    .mode("overwrite")
    .option("overwriteSchema", True)
    .option("path", f"{SILVER_PATH}/dallas_violations")
